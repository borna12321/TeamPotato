...
public class GameManager : MonoBehaviour
{
    ...
    public bool playCoughSound =false;
    public static bool isFarmChosen=false;
    public static bool isWoodChosen=false;

    public GameObject tilePrefab;
    public static bool isBuildingChosen = false;
    ...
    public void SpawnBuilding(BuildingObject building, List<TileObject> tiles)
    {
       ...
       if (building.data.resourceType == Building.ResourceType.Food)
       {
           ...
           isFarmChosen=true;
           ResourceManager.Instance.AddCO2(5);
           SoundManager.Instance.HmmSound();
           SoundManager.Instance.CoughSound();
           ResourceManager.Instance.RemoveStandardC(30);
            
       }
    
        if (building.data.resourceType == Building.ResourceType.CO2)
        {
            
            ResourceManager.Instance.RemoveCO2(10);
            isWoodChosen=true;
            SoundManager.Instance.CoughSound();
            SoundManager.Instance.HmmSound();
            ResourceManager.Instance.RemoveStandardC(30);
